...
## ソースコードの説明
l.24: argv[1]をsscanfでmuに読み込む

l.25: argv[2]をsscanfでsigmaに読み込む

l.26: argv[3]をsscanfでnum_dummyに読み込む
...
l.35: i=1からi<=num_dummyまで以下を繰り返す

l.37: dummyにsigma*r_stdnorm()+muを代入

l.38: dummyの値を出力

l.44: 疑似乱数（整数）を1つ生成する関数を作る

l.49: 平均0，分散1の標準正規乱数生成関数を作る
